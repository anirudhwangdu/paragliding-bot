    ...
    sections: [
      {
        ...
        rows: [
          { id: "blr_thriller", title: "Thriller Scenic Exp", description: "Most Popular · ₹14,999/person · 25-30 min · up to 2500ft",
          ...
          { id: "blr_sunset", title: "Sunset Solo Experience", description: "₹16,999/person · 25-30 min · golden hour flight",
            details: "🪂 Sunset Solo Experience\n₹16,999/person\nDuration: 25-30 min | Altitude: up to 2,500ft\nIncludes: Golden hour sunset flight & cinematic edited reel." },
          { id: "blr_couple", title: "Love in the Air", description: "₹24,999/couple · 25-30 min each · side-by-side flight",
      ...
      },
      {
        ...
        rows: [
         { id: "blr_intro", title: "Tandem Introductory", description: "₹3,999/person · 7 min · up to 1000ft",
          ...
          { id: "blr_classicthr", title: "SkySail Thriller Flight", description: "₹6,999/person · 12 min · up to 2000ft",
          ...
          { id: "blr_birthday", title: "Birthday Blast Off!", description: "₹6,999/person · 15 min · birthday special",
          ...
          { id: "blr_pet", title: "Fluff 'n' Flight", description: "₹6,999/pair · 15 min · 1 adult + 1 pet",
